return {
    descriptions = {
        Enhanced = {
            ...
            m_ele_cardboard = {
                ...
                text = {
                    ...
                    " a {C:tarot}Tarot card{} when held in hand",
                },
            },
        },
        Edition = {
        ...
        Blind = {
            bl_ele_candle_final = {
                name = "Tangerine Candle",
                text = {
                    "Base Chips and",
                    "Mult are divided by 8",
                },
            },
            bl_ele_club_final = {
                name = "Aquamarine Club",
                text = {
                    "Set level of",
                    "poker hand to 1",
                },
            ...
            bl_ele_coin_final = {
                name = "Emerald Coin",
                text = {
                    "1 in 3 card are drawn face down",
                    "1 in 4 card are debuffed",
                },
            },
            bl_ele_hourglass_final = {
        ...
        Voucher = {
            v_ele_metal_merchant = {
                name = "Metal Merchant",
                text = {
                    "{C:metal}Metal{} cards appear",
